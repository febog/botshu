...
module.exports = {
     ...
     */
    enableBot() {
        if (this.debug) console.log("enableBot triggered");
     ...
     */
    disableBot() {
        if (this.debug) console.log("disableBot triggered");
     ...
     */
    isStreamLive() {
        if (this.debug) console.log("isStreamLive triggered");
     ...
     */
    setStreamLive() {
        if (this.debug) console.log("setStreamLive triggered");
     ...
     */
    setStreamOffline() {
        if (this.debug) console.log("setStreamOffline triggered");
        this.state.streamLive = false;
    },
    /**
